...
<main>
  <div class="w-screen h-screen flex items-center flex-col pt-48">
    {#each people as person (person.id)}
      <div class="py-3">
        ...
        <button on:click={() => handleRemovePerson(person.id)} class="bg-stone-100 p-1 px-3 rounded mt-1">Remove</button>
      </div>
    {:else}
